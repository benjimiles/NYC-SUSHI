...
const Reservation = () => {
  return (
    ...
    <div className="w-full h-[70%] text-center flex flex-col items-center justify-center px-4 text-white">
      <h1 className="text-[25px] mt-6 text-white">Book a Reservation</h1>
      <label className="relative mb-2 text-white">Select Time:</label>
      <div>
        <input
        ...
        ></input>
        <input
        className="mx-4 border relative bg-transparent text-white p-2"
        type="text"
