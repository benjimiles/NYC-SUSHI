  ...
  return (
    <div className="w-full h-full top-[100%] bg-zinc-900/70">
      ...
      <div className="w-full h-[100%] text-center flex flex-col items-center justify-center py-40 text-white">
        ...
        <p className="text-[16px] my-3 sm:my-5 font-bold">
          Embark on a Journey of Sushi Enchantment at New York City Sushi: Where Urban Dynamism Meets Culinary Artistry!
        </p>
        <p className="text-white sm:px-12 lg:px-80 font-Teko sm:text-2xl lg:text-xl">
          {' '}
          Nestled in the heart of the city that never sleeps, New York City Sushi isn't just a restaurant; it's a
        ...
        <p className="text-white sm:px-12 lg:px-80 font-Teko pt-5 sm:pt-10 text-lg sm:text-2xl lg:text-xl">
          The fusion of diverse cultures, the boldness of urban creativity, and the precision of culinary craftsmanship
          converge within our walls. From the moment you step in, you're not just dining; you're becoming part of a
