    ...
    <div className="bg-white max-w-full mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
        <div className="rounded-xl relative">
            <div className="absolute w-full h-full bg-black/40 text-white text-center">
                ...
                <button className="border active:bg-blue-400 hover:bg-white hover:text-black duration-300 text-white bg-black mx-2 bottom-4 rounded px-4 py-2"><Link href="/Delivery">Deliver Food</Link></button>
            </div>
        ...
        <div className="rounded-xl relative">
            <div className="absolute w-full h-full bg-black/40 text-white text-center">
                ...
                <button className="border active:bg-blue-400 hover:bg-white hover:text-black duration-300 text-white bg-black mx-2 bottom-4 rounded px-4 py-2"><Link href="/Store">Write Review</Link></button>
            </div>
        ...
        <div className="rounded-xl relative">
            <div className="absolute w-full h-full bg-black/40 text-white text-center">
                ...
                <button className="border active:bg-blue-400 hover:bg-white hover:text-black duration-300 text-white bg-black mx-2 bottom-4 rounded px-4 py-2"><Link href="/Chef">Find Chefs</Link></button>
            </div>
